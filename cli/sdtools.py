...
def make_scan(case, overwrite=False):
    ...
    if intend_dens != case_dens:
        print(
            f"Case {case} density mismatch. Found: {case_dens:.1E} || Case name implies: {intend_dens:.1E}"
        )
...
if __name__ == "__main__":
    ...
    p_is_finished.add_argument(
        "-i", type=str, nargs=1, required=True, help="Tell you if case finished"
    )
