...
def parse_petsc_logview(path):
    ...
    perf_lines[3] = perf_lines[3].replace(
        "Total BOUT++", "Total_BOUT++"
    )  # Remove space which we use for delimiter
    # perf_lines
    ...
    for line in perf_lines:
        ...
        data_delimiter = line.split(split[2])[
            0
        ]  # data after second column has hardcoded widths
